...
//Code Here
let animal1 = new Animal('Tiger', 'feline', 'meat')
...
let context1 = whatIsThis('THIS IS')
...
let context2 = func(product.description)
...
let context3 = vacation.whatIsThis(whatIsThis)
