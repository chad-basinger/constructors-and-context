...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  // const newPost1 = new User(2, 'Seth Fast 2', 4);
  // newPost1.addSavedPost(2, 'Fast 2', 4)
  ...
  User.prototype.removeSavedPost = function(postId){
    let updatedPosts = this.savedPosts;
    updatedPosts.splice(this.savedPosts.findIndex(v => v.id === postId), 1);
  }
  ...
  User.prototype.changePostRating = function(id, newRating){
    elemIndex = this.savedPosts.findIndex(v => v.id === id);
    this.savedPosts[elemIndex].rating = newRating;
  }